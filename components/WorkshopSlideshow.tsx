...
export default function WorkshopSlideshow() {
  ...
  return (
    <div className="mx-auto mt-10 max-w-xl">
      <div
        className={`rounded-lg p-8 text-white shadow-lg ${slides[currentSlide].background} relative overflow-hidden border border-primary/20`}
      >
        <div className="flex flex-col">
          <div className="absolute left-4 top-4 text-8xl opacity-10">
      ...
      <div className="mt-6 flex justify-between">
        <button
          onClick={prevSlide}
          className="rounded-lg bg-primary px-4 py-2 font-semibold text-black transition-all hover:bg-primary/90"
        >
          Previous
        </button>
